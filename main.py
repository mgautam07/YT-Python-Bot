...
async def on_ready():
    '''                         check_new_videos()                             '''
    # await client.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name='Hermitcraft'))
    await client.change_presence(activity=discord.Game(name='Hermitcraft'))
...
# @client.command(help="Sets role to mention!")
# async def mention_role(ctx, role):
...
# @client.command(help = "Bot command.")
